...
Атрибуты подхватываются и с родительских классов: парсер `aura` проходит всю цепочку наследования и сливает метаданные в одну ауру — общие описания и фильтры можно держать в базовом классе.
